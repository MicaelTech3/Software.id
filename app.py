...
def main():
    ...
    win = QMainWindow(); win.setWindowTitle("App Remoto (PySide6)")
    central = QWidget(); layout = QVBoxLayout(central)
    lbl = QLabel("Rodando remotamente ✅"); lbl.setAlignment(Qt.AlignCenter)
    ...
    win.setCentralWidget(central); win.resize(520, 260); win.show()
    sys.exit(app.exec())
